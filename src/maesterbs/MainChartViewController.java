...
public class MainChartViewController implements Initializable {
	...
	ObservableList<String> stock = FXCollections.observableArrayList("JNJ", "(MMM)", "UnitedTechnologiesr",
			"WalMartStores");
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		obj.UpdateData(stockChoice.getValue(), movingAverageRange.getValue(),
				calculateStartDate(HistoricalDataRange.getValue()), end);
